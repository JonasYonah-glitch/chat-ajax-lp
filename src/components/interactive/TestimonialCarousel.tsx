            ...
            >
              {testimonials.map((t, index) => (
                ...
                >
                  ...
                  {/* Right: quote */}
                  <div className="bg-white p-7 max-md:p-5 flex flex-col justify-center relative overflow-hidden">
                    {/* Large decorative quote mark — background watermark */}
                    <svg
                      width="120"
                      height="120"
                      viewBox="0 0 24 24"
                      fill="#5E17EB"
                      className="absolute -top-2 -left-2 opacity-[0.06] pointer-events-none"
                      aria-hidden="true"
                    >
                    ...
                    <blockquote className="relative text-sm max-md:text-[13px] text-[#131313]/80 leading-[1.7] mb-5 max-md:mb-4 italic">
                      {t.quote}
                    </blockquote>
