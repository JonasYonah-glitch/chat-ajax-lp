      ...
      <Container>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            ...
            <div className="cert-card flex flex-col items-center text-center p-8 bg-ajax-white border-2 border-ajax-purple/30 shadow-[4px_4px_0_#5E17EB] md:border-ajax-black/10 md:shadow-none transition-all hover:-translate-y-0.5 hover:shadow-[4px_4px_0_#5E17EB] hover:border-ajax-purple/30">
              <img
              ...
              <p className="text-xs text-ajax-black/60">Meta Business Partner</p>
            </div>
            ...
            <div className="cert-card flex flex-col items-center text-center p-8 bg-ajax-white border-2 border-ajax-purple/30 shadow-[4px_4px_0_#5E17EB] md:border-ajax-black/10 md:shadow-none transition-all hover:-translate-y-0.5 hover:shadow-[4px_4px_0_#5E17EB] hover:border-ajax-purple/30">
              ...
              <p className="text-xs text-ajax-black/60">Google Developer</p>
            </div>
